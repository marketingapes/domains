...
| `pricing/index.html` | The Sofia Campaign — $10,000 / 30 days card, pay button, "own the machine" card, small print |
...
- [ ] **Payment link**: replace `PAY_LINK_PLACEHOLDER` in `pricing/index.html` with the real $10,000 checkout URL (Stripe / QuickBooks payment link). Keep `data-pay`, `data-offer-id`, `data-value`.
